...
class HybridRecommender:
    ...
    def __init__(self, emotion_detector, collab_recommender, data_manager):
        ...
        self.mood_filters = {
            ...
            'love': {'valence': 0.8, 'energy': 0.6},
            'optimism': {'valence': 0.7, 'energy': 0.7},
            'pride': {'valence': 0.7, 'energy': 0.6},
            'caring': {'valence': 0.6, 'energy': 0.4},
    ...
    def recommend(self, user_text, user_id, context=None, top_n=10):
        ...
        for emotion in emotions_found:
            target_features['valence'] += self.mood_filters[emotion]['valence']
            target_features['energy'] += self.mood_filters[emotion]['energy']
        
        target_features /= len(emotions_found)
